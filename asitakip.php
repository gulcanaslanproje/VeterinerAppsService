<?php
	...
	$sor = mysqli_query($baglan,"select a.pet_isim, a.pet_tur, a.pet_cins, a.pet_resim,b.asi_tarih, b.asi_isim from veteriner_pet_listesi a INNER JOIN veteriner_takipasi b on a.id = b.pet_id WHERE a.mus_id = '$mus_id' and b.mus_id = '$mus_id' and b.asi_durum = 0 ");
